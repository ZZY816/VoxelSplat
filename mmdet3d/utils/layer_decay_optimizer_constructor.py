...
def get_vit_lr_decay_rate(name, backbone_lr_decay_rate=1.0, head_lr_decay_rate=1.0, lm_head_lr_decay_rate=0.1,
                          num_layers=12):
    """
        ...
        for name, param in module.named_parameters():
            ...
            if decay_type == "layer_wise":
                ...
                layer_id, scale = get_vit_lr_decay_rate(name, decay_rate,
                                                        ...
                                                        self.paramwise_cfg.get('lm_head_decay_rate', 0.1),
